...
/**
 * Async thunks functions automatically dispatch "pending/fulfilled/failed" action creators.
 * The createAsyncThunk function accepts two arguments:
 * - A string that will be used as the prefix for the generated action types
 * - A "payload creator" callback function that should return a Promise containing some data, or a rejected Promise with an error.
 *
 * The three action types that could be dispatched by the thunk must be handled in the extraReducers slice field:
